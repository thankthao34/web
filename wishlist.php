<?php
  ...
  if (isset($_SESSION['user_id'])) {
    ...
    if (isset($_POST['delete_item'])) {
        ...
        $wishlist_id = htmlspecialchars($wishlist_id, ENT_QUOTES, 'UTF-8');
...
<head>
    ...
    <title>Retro Shop - Wishlist page</title>
</head>
<body>
        ...
        <h1 class="title">products added in wishlist: </h1>
            <div class="box-container">
                ...
                <form method="post" action="" class="box">
                    ...
                    <img class="img" src="img/<?= $fetch_products['image']; ?>">
                    <div class="button">
                        <button type="submit" name="add_to_cart"><i class="bx bx-cart"></i></button>
                        <a href="view_page.php?pid=<?php echo $fetch_products['id']; ?>" class="bx bxs-show">
                        </a> 
